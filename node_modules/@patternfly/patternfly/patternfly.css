...
.pf-c-label-group {
  ...
  --pf-c-label-group--m-vertical__close--MarginRight: calc(var(--pf-global--spacer--sm) * -1);
  --pf-c-label-group--m-vertical__close--MarginLeft: calc(var(--pf-global--spacer--sm) * -1);
  ...
  .pf-c-label-group.pf-m-vertical {
    ...
    --pf-c-label-group__close--MarginTop: 0;
