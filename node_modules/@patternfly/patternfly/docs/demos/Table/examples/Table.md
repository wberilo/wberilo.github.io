    ...
    <section class="pf-c-page__main-section pf-m-no-padding pf-m-padding-on-md">
      <div class="pf-c-card">
        <table class="pf-c-table pf-m-grid-xl" role="grid" aria-label="This is a table showing a loading state" id="table-loading-table">
          ...
          <tbody role="rowgroup">
            <tr class="pf-m-height-auto" role="row">
...
26
        ...
        <div class="pf-c-pagination pf-m-bottom pf-m-static">
          <div class="pf-c-options-menu">
            ...
            <ul class="pf-c-options-menu__menu" aria-labelledby="{{page--id}}-pagination-options-menu-bottom-example-static-toggle" hidden>
              <li>
                <button class="pf-c-options-menu__menu-item" type="button">5 per page</button>
              </li>
              <li>
  ...
  <div class="pf-l-bullseye">
    <div class="pf-c-modal-box pf-m-sm" role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description">
      ...
      <div class="pf-c-modal-box__body" id="modal-description">
        <ul class="pf-c-data-list pf-m-compact" role="list" aria-label="Table column management" id="table-column-management">
          <li class="pf-c-data-list__item" aria-labelledby="table-column-management-item1">
            <div class="pf-c-data-list__item-row">
              <div class="pf-c-data-list__item-control">
                <div class="pf-c-data-list__check">
                  <input type="checkbox" name="table-column-management-check-action-check1" aria-labelledby="table-column-management-item1" checked />
                </div>
              </div>
              <div class="pf-c-data-list__item-content">
                <div class="pf-c-data-list__cell" id="table-column-management-item1">Repositories</div>
              </div>
            </div>
          </li>
          <li class="pf-c-data-list__item" aria-labelledby="table-column-management-item2">
            <div class="pf-c-data-list__item-row">
              <div class="pf-c-data-list__item-control">
                <div class="pf-c-data-list__check">
                  <input type="checkbox" name="table-column-management-check-action-check1" aria-labelledby="table-column-management-item2" checked />
                </div>
              </div>
              <div class="pf-c-data-list__item-content">
                <div class="pf-c-data-list__cell" id="table-column-management-item2">Branches</div>
              </div>
            </div>
          </li>
          <li class="pf-c-data-list__item" aria-labelledby="table-column-management-item3">
            <div class="pf-c-data-list__item-row">
              <div class="pf-c-data-list__item-control">
                <div class="pf-c-data-list__check">
                  <input type="checkbox" name="table-column-management-check-action-check1" aria-labelledby="table-column-management-item3" checked />
                </div>
              </div>
              <div class="pf-c-data-list__item-content">
                <div class="pf-c-data-list__cell" id="table-column-management-item3">Pull requests</div>
              </div>
            </div>
          </li>
          <li class="pf-c-data-list__item" aria-labelledby="table-column-management-item4">
            <div class="pf-c-data-list__item-row">
              <div class="pf-c-data-list__item-control">
                <div class="pf-c-data-list__check">
                  <input type="checkbox" name="table-column-management-check-action-check1" aria-labelledby="table-column-management-item4" checked />
                </div>
              </div>
              <div class="pf-c-data-list__item-content">
                <div class="pf-c-data-list__cell" id="table-column-management-item4">Workspaces</div>
              </div>
            </div>
          </li>
          <li class="pf-c-data-list__item" aria-labelledby="table-column-management-item5">
            <div class="pf-c-data-list__item-row">
              <div class="pf-c-data-list__item-control">
                <div class="pf-c-data-list__check">
                  <input type="checkbox" name="table-column-management-check-action-check1" aria-labelledby="table-column-management-item5" checked />
                </div>
              </div>
              <div class="pf-c-data-list__item-content">
                <div class="pf-c-data-list__cell" id="table-column-management-item5">Last commit</div>
              </div>
            </div>
          </li>
        </ul>
